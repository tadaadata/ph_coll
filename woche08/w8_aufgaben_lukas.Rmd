...
Nutzt eure frischerworbenen `rnorm`-Skills um IQ-Werte vpn 50 Personen zu simulieren, und speichert die Werte als `iq` ab.
...
`summary` ist eine sogenannte *generic function*, die unterschiedliche Dinge tut, davon abhängig, was wir da reinstecken. Testes die Funktion einmal mit dem ganzen Datensatz und mit einzelnen Spalten.
